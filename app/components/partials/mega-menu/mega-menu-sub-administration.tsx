...
const MegaMenuSubAdministration = ({ items }: { items: MenuConfig }) => {
  const administrationItem = items[2];

  return (
    <div className="w-full gap-0 lg:w-[875px]">
      <div className="pt-4 pb-2 lg:p-7.5">
        <div className="grid lg:grid-cols-2 gap-5 lg:gap-10">
          {administrationItem.children?.map((item: MenuItem, index) => {
            return (
...
export { MegaMenuSubAdministration };
